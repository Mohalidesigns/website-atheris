        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-6">
                @foreach([
                    ...
                    ['module' => 'Controls Management', 'problem' => 'Control testing is inconsistent, evidence collection is scattered, and nobody knows which controls are actually effective.', 'solution' => 'Structured control libraries mapped to risks and regulations. Automated testing schedules, evidence capture, and effectiveness scoring. Failed controls trigger immediate escalation.', 'link' => '/solutions/controls-management'],
