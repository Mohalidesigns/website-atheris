<x-app-layout metaTitle="Contact Us — Atheris GRC" metaDescription="Get in touch with the Atheris team. We'll respond to your governance, risk, and compliance enquiry shortly.">
    @push('head') @include('partials.schema-localbusiness') @endpush
                ...
                <div class="space-y-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <a href="mailto:{{ config('seo.organization.email') }}" class="text-sm text-text-secondary hover:text-primary transition">{{ config('seo.organization.email') }}</a>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-text-primary">Phone</p>
                            <a href="tel:{{ config('seo.organization.telephone') }}" class="text-sm text-text-secondary hover:text-primary transition">{{ config('seo.organization.telephone_display') }}</a>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
