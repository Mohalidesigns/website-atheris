            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="hidden lg:block">
                    <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                        {{-- Placeholder 1: VMS Dashboard Screenshot --}}
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                {{-- Placeholder 2: VMS Check-in Screen --}}
                <div class="bg-bg rounded-2xl p-6 border border-border">
                    ...
                    <p class="text-sm text-text-secondary mt-4 text-center">Self-service kiosk interface for visitor registration</p>
                </div>
                {{-- Placeholder 3: VMS Analytics Dashboard --}}
                <div class="bg-bg rounded-2xl p-6 border border-border">
                    <div class="bg-white rounded-xl aspect-[4/3] flex items-center justify-center text-text-secondary/30 border border-dashed border-border">
                        <div class="text-center">
                    ...
                    <p class="text-sm text-text-secondary mt-4 text-center">Real-time visitor analytics and occupancy tracking</p>
                </div>
            </div>
        </div>
    </section>
